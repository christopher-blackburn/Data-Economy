...
Confronting this challenge, I introduce a new method for valuing the data economy using online job postings. The method applies an unsupervised machine learning algorithm to online job advertisements to estimate the labor costs of data-related activities. Our method augments the traditional labor costs methodology by proxying time-use factors using only the language contained in job posting text. Using this method, we estimate data-related (nominal) labor costs grew from $100 billion in 2010 to more than $200 billion in 2018, representing an average annual growth rate of 9.7 percent. 
